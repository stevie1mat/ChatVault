...
export default function UploadPage() {
  ...
  const handleChatParsed = async (data: ParsedChatData) => {
    ...
    try {
      // Validate and clean timestamps before storing
      const cleanedMessages = data.messages.map(msg => {
        // Check if timestamp is valid
        if (isNaN(msg.timestamp.getTime())) {
          console.warn(`⚠️ Invalid timestamp found for message ${msg.id}, using current date`);
          return {
            ...msg,
      ...
      // Validate date range
      const startDate = isNaN(data.dateRange.start.getTime()) ? new Date() : data.dateRange.start;
      const endDate = isNaN(data.dateRange.end.getTime()) ? new Date() : data.dateRange.end;
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col space-y-2 text-sm text-gray-600">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>No Data Saved or Used for AI Training</span>
              </div>
            </div>
          </div>
              ...
              <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700">
                <div className="flex items-start space-x-2">
                  ...
                  <div className="text-xs text-blue-700 dark:text-blue-300">
                    <strong>Privacy Notice:</strong> Your chat data is processed locally and temporarily for analysis. No data is saved to our servers or used for AI training. Your conversations remain private and secure.
                  </div>
                </div>
              </div>
            </div>
