      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-8 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {chatData.participants.map((participant: string, index: number) => {
            ...
            return (
              <div key={participant} className="group relative bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-600 hover:shadow-lg transition-all duration-300">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    <div className={`w-8 h-8 bg-gradient-to-r ${rankColors[index % rankColors.length]} rounded-lg flex items-center justify-center mr-3`}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-lg h-2 mt-3">
                    <div 
      ...
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-8 text-white">
        <div className="text-center space-y-4">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            <a href="/chat/analytics/sentiment" className="px-6 py-3 bg-white/20 backdrop-blur-sm rounded-lg hover:bg-white/30 transition-all duration-200 font-medium">
              😊 Sentiment Analysis
            </a>
            <a href="/chat/analytics/topics" className="px-6 py-3 bg-white/20 backdrop-blur-sm rounded-lg hover:bg-white/30 transition-all duration-200 font-medium">
              🗣️ Topic Modeling
            </a>
            <a href="/chat/analytics/patterns" className="px-6 py-3 bg-white/20 backdrop-blur-sm rounded-lg hover:bg-white/30 transition-all duration-200 font-medium">
              🔄 Conversation Patterns
            </a>
            <a href="/chat/analytics/response-times" className="px-6 py-3 bg-white/20 backdrop-blur-sm rounded-lg hover:bg-white/30 transition-all duration-200 font-medium">
              ⏱️ Response Times
            </a>
          </div>
        </div>
